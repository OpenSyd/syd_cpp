  ...
  foreach(ODB_FILES ${ARGN})
    ...
    if(EXISTS ${ODB_FILES_ABS})
      add_custom_command(OUTPUT ${ODB_OUTPUT}
        ...
        ARGS --std c++11 --database sqlite -I${DCMTK_INCLUDE_DIR_BASE} -I${SYD_SOURCE_DIR}/src/std_db -I${SYD_SOURCE_DIR}/src/core  -I${SYD_SOURCE_DIR}/src/common_db  -I${SYD_SOURCE_DIR}/src/ext  --generate-schema --schema-format separate  --generate-query --sqlite-override-null --schema-name ${SCHEMA_NAME} ${ODB_FILES_ABS}
