...
macro(WRAP_ODB ODB_SRCS)
  foreach(ODB_FILES ${ARGN})
    ...
    add_custom_command(OUTPUT ${ODB_OUTPUT}
      COMMAND odb
      ARGS --std c++11 --database sqlite -I${PROJECT_SOURCE_DIR}/src/std_db -I${PROJECT_SOURCE_DIR}/src/core --generate-schema --schema-format embedded --generate-query --sqlite-override-null --schema-name ${SCHEMA_NAME} ${ODB_FILES_ABS}
