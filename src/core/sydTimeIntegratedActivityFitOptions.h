...
namespace syd {
  ...
  public:
    ...
    // Input
    void SetR2MinThreshold(float r) { R2_min_threshold_ = r; }
    ...
    float GetR2MinThreshold() const { return R2_min_threshold_; }
    float & GetR2MinThreshold() { return R2_min_threshold_; }
    bool GetRestrictedFlag() const { return restricted_flag_; }
    bool & GetRestrictedFlag() { return restricted_flag_; }
    int GetMaxNumIterations() const { return max_num_iterations_; }
    int & GetMaxNumIterations() { return max_num_iterations_; }
