...
#ifndef SYDFITMODEL_F5_H
#define SYDFITMODEL_F5_H
...
namespace syd {
  ...
  class FitModel_f5: public FitModelBase
  {
  public:
    ...
    virtual int GetNumberOfExpo() const { return 3;}
    ...
    typedef ceres::AutoDiffCostFunction<ResidualType, 1, 1, 1, 1, 1, 1> CostFctType;
