...
namespace syd {
  ...
  public:
    ...
    virtual Database * Create(std::string dbtype, std::string filename, std::string folder) = 0;
  ...
  public:
    ...
    virtual Database* Create(std::string dbtype, std::string filename, std::string folder);
  };
