...
void syd::FitModel_f4c::SetProblemResidual(ceres::Problem * problem, syd::TimeActivityCurve & tac)
{
  ...
  problem->SetParameterLowerBound(&params_[0], 0, 0.0);   // l_r positive
  problem->SetParameterLowerBound(&params_[1], 0, 0.0);   // l_r positive
  problem->SetParameterLowerBound(&params_[2], 0, 0.0);   // l_h positive
}
// --------------------------------------------------------------------
...
// --------------------------------------------------------------------
void syd::FitModel_f4c::Scale(double s)
{
  LOG(FATAL) << "No yet scale for 4c";
}
// --------------------------------------------------------------------
