...
BuildFields(const syd::Database * db) const
{
  ...
  ADD_RO_FIELD(mass_scaling, double);
  ...
  field_format_map_["default"] =
    "id target_fit_timepoints.id[t_fit_tp] tags sources_ftp[s_fit_tp] absorbed_dose_in_Gy[Gy] target_mass_in_kg[mass] mass_scaling[ms] S phantom_name[ph] target_organ_name[target] source_organs[sources] target_roitype.name[target] sources_rt[sources]";
